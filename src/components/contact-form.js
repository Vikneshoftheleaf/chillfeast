    ...
    return (
        <section class="bg-white dark:bg-gray-900">
            <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white">Get in Touch with Chillfeast</h2>
                <p class="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Reach out today to discuss your project, ask questions, or request a quote. Let’s bring your vision to life!
</p>
                <form action="https://formspree.io/f/mwpvlznz" method="POST" class="space-y-8">
                    <div>
