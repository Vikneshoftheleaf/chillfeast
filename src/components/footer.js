    ...
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-sm lg:w-2/4 px-4">Need a new website or chatbot for your business? Contact Chillfeast today to discuss your project. We offer custom WordPress sites, static sites, and chatbot solutions tailored to your needs.</p>
          </div>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://flowbite.com/" class="hover:underline">Chillfeast</a>. All Rights Reserved.
          </span>
