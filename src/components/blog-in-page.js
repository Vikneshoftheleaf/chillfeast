        ...
        <>
            ...
            <main class="pt-8 pb-16 lg:pt-16 lg:pb-24 bg-white dark:bg-gray-900 antialiased">
                ...
                <div class="flex justify-between px-4 mx-auto max-w-screen-xl ">
                    <article class="flex flex-col gap-4 mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
                            ...
                            <address class="flex items-center mb-6 not-italic">
                                <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-base text-gray-500 dark:text-gray-400">{data.role}</p>
                                        <p class="text-base text-gray-500 dark:text-gray-400"><time pubdate datetime="2022-02-08" title="February 8th, 2022">{data.date}</time></p>
                                    </div>
                                </div>
                            </address>
                            <h1 class="capitalize mb-4 text-3xl font-extrabold leading-tight text-gray-900 lg:mb-6 lg:text-4xl dark:text-white">{data.title}</h1>
                        </header>
